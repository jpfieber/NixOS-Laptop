{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-ad6f9e0d-a6ae-4d28-b65a-5bb1d0c65db0 = [ ];
      ...
      Strawberry.stop = [ ];
      "com.google.Chrome"."603D57D750C3A00536B7DCEB9BFE774A-autofill_card" = [ ];
      "com.google.Chrome"."603D57D750C3A00536B7DCEB9BFE774A-autofill_identity" = [ ];
      "com.google.Chrome"."603D57D750C3A00536B7DCEB9BFE774A-autofill_login" = [ ];
      "com.google.Chrome"."603D57D750C3A00536B7DCEB9BFE774A-generate_password" = [ ];
      "com.google.Chrome"."603D57D750C3A00536B7DCEB9BFE774A-lock_vault" = [ ];
      "com.google.Chrome".B65F1DDE94CCE8C82F00EAC3AF37BD06-enter-picker-mode = [ ];
      "com.google.Chrome".B65F1DDE94CCE8C82F00EAC3AF37BD06-enter-zapper-mode = [ ];
      "com.google.Chrome".BF481D5E53D5A0A960733AF3B3C83C8E-quick_clip = [ ];
      "com.google.Chrome".BF481D5E53D5A0A960733AF3B3C83C8E-toggle_highlighter = [ ];
      "com.google.Chrome".BF481D5E53D5A0A960733AF3B3C83C8E-toggle_reader = [ ];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2025,12,3,11,20,36.455";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities.ad6f9e0d-a6ae-4d28-b65a-5bb1d0c65db0 = "Default";
      kactivitymanagerdrc.main.currentActivity = "ad6f9e0d-a6ae-4d28-b65a-5bb1d0c65db0";
      ...
      kdeglobals.Icons.Theme = "Win11-dark";
      ...
      kwinrc.Desktops.Id_1 = "ec0fe40a-7912-4ba2-8132-ce1285669a21";
      ...
      kwinrc."Tiling/ec0fe40a-7912-4ba2-8132-ce1285669a21/f9a4e8c8-5068-4d9b-86f3-ff84fb7318ac".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc.Xwayland.Scale = 1;
      plasma-localerc.Formats.LANG = "en_US.UTF-8";
      plasmanotifyrc."Applications/google-chrome".Seen = true;
      plasmarc.Wallpapers.usersWallpapers = "/nix/store/vsvlbrhb7cn965a46wdng83dk7sakzrl-plasma-workspace-wallpapers-6.5.3/share/wallpapers/Kay/contents/images/1080x1920.png";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/jpfieber/.config/rclone/rclone.conf";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-H-Splitter = "0,3795,0";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 1979;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 3558;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,1979,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 3795;
